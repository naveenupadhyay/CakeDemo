...
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
public class CakeDemoWebUtils {

    private static final Logger LOG = LoggerFactory.getLogger(CakeDemoWebUtils.class);
    ...
    public static String determineAutoRedirctUrl(CakeDemoUser user) {
