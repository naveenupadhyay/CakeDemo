...
<html>
<head>
<title>Cake Associate Login</title>
...
<body style="background: url(http://retaildesignblog.net/wp-content/uploads/2012/04/OCAKE-American-bakery-Plasma-Medellin-02.jpg) ; background-position: center; background-size:cover; background-repeat:repeat-y ">
	...
	<div id="newSubscriber"></div>
	 ...
	 <c:set var="loginPath" value="${path.http}/login_security_check?"/>
		...
		<div class="signupBoxDiv">
			...
			<div class="register_head">Cake Associate Login</div>
