package com.walmart.cakedemo.configuration;
...
public class ConfigUtils {
     ...
     * <p>
     * 3. Name of the {@link Property} present in {@link com.walmart.cakedemoProperty.core.entity.ShippingProperty} table.
     * <p>
     ...
     * {@link com.walmart.cakedemoProperty.core.entity.ShippingProperty} will never have environment prefixed.
     * <p>
     * 
     * @param p
     * @return
    ...
    public static String getStringScalar(Property p) {
        ...
        if (StringUtils.isEmpty(value)) {
            value = CacheManager.getInstance().getCache(CakeDemoPropertiesCache.class).getProperty(p.getName());
        }
    ...
    public static List<String> getStringList(Property p, String delimitor) {
        ...
        if (list == null) {
            String propValue = CacheManager.getInstance().getCache(CakeDemoPropertiesCache.class).getProperty(p.getName());
